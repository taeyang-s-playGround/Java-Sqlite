package JavaProject.Sqlite.global.error;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DayoungException.class)
    public ResponseEntity<ErrorResponse> handleBusinessException(DayoungException e) {
